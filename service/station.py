...
async def add_task_to_db(db, add_gps_latitude, add_gps_longitude, add_priority, add_task_status):
    return await db_serice.create_task_in_db(db, add_gps_latitude, add_gps_longitude, add_priority, add_task_status)
